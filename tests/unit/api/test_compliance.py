...
class TestRegulationsAPI:
    ...
    def test_list_regulations_filter_by_project(self, client: TestClient) -> None:
        ...
        client.post(
            "/api/v1/regulations",
            json={"regulation_id": "reg-a", "project_id": "proj-a", "name": "GDPR"},
        )
        client.post(
            "/api/v1/regulations",
            json={"regulation_id": "reg-b", "project_id": "proj-b", "name": "HIPAA"},
        )
    ...
    def test_get_regulation(self, client: TestClient) -> None:
        ...
        client.post(
            "/api/v1/regulations",
            json={"regulation_id": "reg-2", "project_id": "proj-1", "name": "GDPR"},
        )
    ...
    def test_update_regulation(self, client: TestClient) -> None:
        ...
        client.post(
            "/api/v1/regulations",
            json={"regulation_id": "reg-3", "project_id": "proj-1", "name": "IEC 62304"},
        )
        resp = client.patch(
            "/api/v1/regulations/reg-3", json={"name": "IEC 62304:2015", "risk_level": "critical"}
        )
        assert resp.status_code == 200
    ...
    def test_delete_regulation(self, client: TestClient) -> None:
        ...
        client.post(
            "/api/v1/regulations",
            json={"regulation_id": "reg-4", "project_id": "proj-1", "name": "To Delete"},
        )
    ...
    def test_create_duplicate_regulation_returns_409(self, client: TestClient) -> None:
        ...
        client.post(
            "/api/v1/regulations",
            json={"regulation_id": "reg-dup", "project_id": "proj-1", "name": "HIPAA"},
        )
        resp = client.post(
            "/api/v1/regulations",
            json={"regulation_id": "reg-dup", "project_id": "proj-1", "name": "HIPAA"},
...
class TestCompliancePoliciesAPI:
    def test_create_compliance_policy(self, client: TestClient) -> None:
        ...
        client.post(
            "/api/v1/regulations",
            json={"regulation_id": "reg-1", "project_id": "proj-1", "name": "HIPAA"},
        )
        resp = client.post(
    ...
    def test_update_compliance_policy(self, client: TestClient) -> None:
        ...
        client.post(
            "/api/v1/compliance-policies",
            json={"policy_id": "cpol-2", "project_id": "proj-1", "name": "Policy A"},
        )
        resp = client.patch(
            "/api/v1/compliance-policies/cpol-2", json={"name": "Policy A v2", "status": "active"}
        )
        assert resp.status_code == 200
    ...
    def test_delete_compliance_policy(self, client: TestClient) -> None:
        ...
        client.post(
            "/api/v1/compliance-policies",
            json={"policy_id": "cpol-3", "project_id": "proj-1", "name": "Delete Me"},
        )
...
class TestProceduresAPI:
    ...
    def test_update_procedure(self, client: TestClient) -> None:
        ...
        client.post(
            "/api/v1/procedures",
            json={"procedure_id": "proc-2", "project_id": "proj-1", "name": "Proc A"},
        )
    ...
    def test_delete_procedure(self, client: TestClient) -> None:
        ...
        client.post(
            "/api/v1/procedures",
            json={"procedure_id": "proc-3", "project_id": "proj-1", "name": "Delete Me"},
        )
...
class TestPracticesAPI:
    ...
    def test_list_and_filter_practices(self, client: TestClient) -> None:
        ...
        client.post(
            "/api/v1/practices",
            json={"practice_id": "prac-a", "project_id": "proj-x", "name": "Prac A"},
        )
    ...
    def test_delete_practice(self, client: TestClient) -> None:
        ...
        client.post(
            "/api/v1/practices",
            json={"practice_id": "prac-d", "project_id": "proj-1", "name": "Delete Me"},
        )
...
class TestStrategiesAPI:
    ...
    def test_update_strategy(self, client: TestClient) -> None:
        ...
        client.post(
            "/api/v1/strategies",
            json={"strategy_id": "strat-2", "project_id": "proj-1", "name": "Sec Strategy"},
        )
    ...
    def test_delete_strategy(self, client: TestClient) -> None:
        ...
        client.post(
            "/api/v1/strategies",
            json={"strategy_id": "strat-3", "project_id": "proj-1", "name": "Delete Me"},
        )
...
class TestKnowledgeEntriesAPI:
    ...
    def test_update_knowledge_entry(self, client: TestClient) -> None:
        ...
        client.post(
            "/api/v1/knowledge-entries",
            json={"entry_id": "ke-2", "project_id": "proj-1", "name": "API"},
        )
        resp = client.patch(
            "/api/v1/knowledge-entries/ke-2",
            json={"entry_type": "api_endpoint", "description": "REST API"},
        )
        assert resp.status_code == 200
    ...
    def test_delete_knowledge_entry(self, client: TestClient) -> None:
        ...
        client.post(
            "/api/v1/knowledge-entries",
            json={"entry_id": "ke-3", "project_id": "proj-1", "name": "Delete Me"},
        )
...
class TestKnowledgeExtractionsAPI:
    ...
    def test_get_extraction(self, client: TestClient) -> None:
        _create_project(client)
        client.post(
            "/api/v1/knowledge-extractions", json={"run_id": "ext-2", "project_id": "proj-1"}
        )
...
class TestComplianceOverviewAPI:
    ...
    def test_overview_with_data(self, client: TestClient) -> None:
        ...
        client.post(
            "/api/v1/strategies",
            json={"strategy_id": "s1", "project_id": "proj-1", "name": "Testing Strategy"},
        )
        client.post(
            "/api/v1/kpis", json={"kpi_id": "k1", "project_id": "proj-1", "name": "Coverage"}
        )
