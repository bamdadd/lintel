...
async def create_policy(
    ...
    await dispatch_event(request, PolicyCreated(payload={"resource_id": policy.policy_id}), stream_id=f"policy:{policy.policy_id}")
...
async def update_policy(
    ...
    await dispatch_event(request, PolicyUpdated(payload={"resource_id": policy_id}), stream_id=f"policy:{policy_id}")
...
async def delete_policy(
    ...
    await dispatch_event(request, PolicyRemoved(payload={"resource_id": policy_id}), stream_id=f"policy:{policy_id}")
