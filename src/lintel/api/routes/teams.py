...
async def create_team(
    ...
    await dispatch_event(request, TeamCreated(payload={"resource_id": body.team_id, "name": body.name}), stream_id=f"team:{body.team_id}")
...
async def update_team(
    ...
    await dispatch_event(request, TeamUpdated(payload={"resource_id": team_id, "fields": list(updates.keys())}), stream_id=f"team:{team_id}")
...
async def delete_team(
    ...
    await dispatch_event(request, TeamRemoved(payload={"resource_id": team_id, "name": team.name}), stream_id=f"team:{team_id}")
