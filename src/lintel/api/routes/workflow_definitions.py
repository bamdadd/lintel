...
from lintel.contracts.events import WorkflowDefinitionCreated, WorkflowDefinitionUpdated, WorkflowDefinitionRemoved
...
async def create_workflow_definition(
    ...
    await dispatch_event(request, WorkflowDefinitionCreated(payload={"resource_id": body.definition_id}), stream_id=f"workflow_definition:{body.definition_id}")
    return entry
...
async def update_workflow_definition(
    ...
    await dispatch_event(request, WorkflowDefinitionUpdated(payload={"resource_id": definition_id}), stream_id=f"workflow_definition:{definition_id}")
    return entry
...
async def delete_workflow_definition(definition_id: str, request: Request) -> None:
    ...
    await dispatch_event(request, WorkflowDefinitionRemoved(payload={"resource_id": definition_id}), stream_id=f"workflow_definition:{definition_id}")
