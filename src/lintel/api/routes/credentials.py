...
async def store_credential(
    ...
    await dispatch_event(request, CredentialStored(payload={"resource_id": body.credential_id, "name": body.name, "credential_type": body.credential_type}), stream_id=f"credential:{body.credential_id}")
    result = asdict(cred)
...
async def revoke_credential(
    ...
    await dispatch_event(request, CredentialRevoked(payload={"resource_id": credential_id}), stream_id=f"credential:{credential_id}")
