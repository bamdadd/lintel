...
async def create_variable(
    ...
    await dispatch_event(request, VariableCreated(payload={"resource_id": variable.variable_id}), stream_id=f"variable:{variable.variable_id}")
...
async def update_variable(
    ...
    await dispatch_event(request, VariableUpdated(payload={"resource_id": variable_id}), stream_id=f"variable:{variable_id}")
...
async def delete_variable(
    ...
    await dispatch_event(request, VariableRemoved(payload={"resource_id": variable_id}), stream_id=f"variable:{variable_id}")
