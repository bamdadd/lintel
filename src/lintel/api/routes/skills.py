...
from lintel.contracts.events import SkillRegistered, SkillUpdated, SkillRemoved, SkillInvoked
...
async def register_skill(
    ...
    await dispatch_event(request, SkillRegistered(payload={"resource_id": body.skill_id}), stream_id=f"skill:{body.skill_id}")
...
async def update_skill(
    ...
    await dispatch_event(request, SkillUpdated(payload={"resource_id": skill_id}), stream_id=f"skill:{skill_id}")
...
async def delete_skill(
    ...
    await dispatch_event(request, SkillRemoved(payload={"resource_id": skill_id}), stream_id=f"skill:{skill_id}")
...
async def invoke_skill(
    ...
    try:
        ...
        raise HTTPException(status_code=404, detail="Skill not found")  # noqa: B904
    await dispatch_event(request, SkillInvoked(payload={"resource_id": skill_id}), stream_id=f"skill:{skill_id}")
