...
SEED_REGULATIONS: list[Regulation] = [
    ...
    Regulation(
        ...
        project_id="",
        name="MDR 2017/745",
        description="EU Medical Devices Regulation. Governs the safety and performance of medical devices placed on the EU market.",
        authority="EU",
    ...
    Regulation(
        ...
        project_id="",
        name="IEC 62304",
        description="Medical device software lifecycle processes. Defines requirements for the development and maintenance of medical device software.",
        authority="IEC",
    ...
    Regulation(
        ...
        project_id="",
        name="ISO 14971",
        description="Application of risk management to medical devices. Framework for identifying hazards, estimating risks, and controlling them.",
        authority="ISO",
    ...
    Regulation(
        ...
        project_id="",
        name="ISO 13485",
        description="Quality management systems for medical devices. Requirements for organisations involved in the lifecycle of medical devices.",
        authority="ISO",
    ...
    Regulation(
        ...
        description="UK domestic medical device regulations (UKCA marking). Applies to medical devices placed on the GB market.",
        authority="MHRA",
    ...
    Regulation(
        ...
        project_id="",
        name="HIPAA",
        description="Health Insurance Portability and Accountability Act. US regulation protecting health information privacy and security.",
        authority="HHS",
    ...
    Regulation(
        ...
        description="NICE evidence standards framework for digital health technologies including Software as a Medical Device.",
        authority="NICE",
        reference_url="https://www.nice.org.uk/about/what-we-do/our-programmes/evidence-standards-framework-for-digital-health-technologies",
        version="2022",
        status=ComplianceStatus.ACTIVE,
        risk_level=RiskLevel.HIGH,
    ...
    Regulation(
        ...
        project_id="",
        name="UK GDPR",
        description="UK General Data Protection Regulation. Governs the processing of personal data of UK residents.",
        authority="ICO",
    ...
    Regulation(
        ...
        description="UK Data Protection Act 2018, supplements the UK GDPR with domestic provisions.",
        authority="ICO",
    ...
    Regulation(
        ...
        project_id="",
        name="FCA Handbook",
        description="Financial Conduct Authority regulatory framework. Covers conduct of business, prudential standards, and consumer protection.",
        authority="FCA",
    ...
    Regulation(
        ...
        description="Payment Services Directive 2 (as transposed into UK law). Regulates payment services including open banking and strong customer authentication.",
        authority="FCA",
    ...
    Regulation(
        ...
        project_id="",
        name="SM&CR",
        description="Senior Managers & Certification Regime. Ensures individual accountability in financial services firms.",
        authority="FCA/PRA",
    ...
    Regulation(
        ...
        project_id="",
        name="Consumer Duty",
        description="FCA Consumer Duty. Requires firms to deliver good outcomes for retail customers.",
        authority="FCA",
    ...
    Regulation(
        ...
        project_id="",
        name="MiFID II (UK)",
        description="Markets in Financial Instruments Directive II as retained in UK law. Governs investment services and trading venues.",
        authority="FCA",
    ...
    Regulation(
        ...
        description="UK Anti-Money Laundering regulations. Requires customer due diligence, reporting, and record-keeping.",
    ...
    Regulation(
        ...
        project_id="",
        name="DORA",
        description="Digital Operational Resilience Act. EU regulation on ICT risk management for financial entities (applicable to UK-EU cross-border firms).",
        authority="EU",
    ...
    Regulation(
        ...
        project_id="",
        name="ISO 27001",
        description="Information security management systems. Framework for managing and protecting information assets.",
        authority="ISO",
    ...
    Regulation(
        ...
        authority="AICPA",
        reference_url="https://www.aicpa.org/topic/audit-assurance/audit-and-assurance-greater-than-soc-2",
        version="2017",
        status=ComplianceStatus.ACTIVE,
    ...
    Regulation(
        ...
        description="Network and Information Systems Regulations. UK implementation of the NIS Directive for operators of essential services.",
        authority="NCSC",
    ...
    Regulation(
        ...
        description="UK government-backed scheme for baseline cyber security controls.",
        authority="NCSC",
    ...
    Regulation(
        ...
        project_id="",
        name="EU AI Act",
        description="Regulation laying down harmonised rules on artificial intelligence. Risk-based framework for AI systems.",
        authority="EU",
