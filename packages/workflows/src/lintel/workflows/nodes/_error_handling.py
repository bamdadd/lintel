...
class WorkflowErrorHandler:
    """Provides standardised error handling for workflow nodes."""
...
async def handle_node_error(
    ...
    Backward-compatible wrapper around :class:`WorkflowErrorHandler`.
    """
    return await WorkflowErrorHandler.handle(state, node_name, error)
