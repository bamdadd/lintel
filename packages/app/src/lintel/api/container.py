...
class AppContainer(containers.DeclarativeContainer):
    ...
    run_metric_store: providers.Provider[Any] = providers.Object(None)
    mutation_store: providers.Provider[Any] = providers.Object(None)
    tournament_store: providers.Provider[Any] = providers.Object(None)
